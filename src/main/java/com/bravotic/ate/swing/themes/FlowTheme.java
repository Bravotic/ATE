...
import com.bravotic.cam.swing.themes.CMenuFlowTheme;
...
/**
 * A theme which uses shades of grey and soft drop shadows.
 */
public class FlowTheme extends CMenuFlowTheme implements ATETheme {
    ...
    public void drawPromptFrame(APrompt model, Graphics g, Rectangle d) {
        ...
        g2.fillRect(d.x + 3, d.y + 3, d.width, d.height);
